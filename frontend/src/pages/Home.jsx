...
<div className="relative bg-gradient-to-b from-blue-200 to-blue-200/30 dark:from-blue-900 dark:to-blue-900/30 w-full min-h-screen pt-0 pb-0">
      <div className="py-8 pt-0 px-4 mx-auto max-w-screen-xl text-center lg:py-16 relative z-10">
        <h1 className="mb-4 text-4xl font-extrabold tracking-tight leading-none text-gray-900 md:text-5xl lg:text-6xl dark:text-white">
         ...
         <h1 className="mb-4 text-4xl font-extrabold tracking-tight leading-none text-gray-900 md:text-5xl lg:text-2xl dark:text-white">
        Ultimate Movies Reviews
        </h1>
        {/* <img src="/banner2.png"  alt="banner" className="pl-0 pr-0"/> */}

        <p className="mb-8 text-lg font-normal text-gray-500 lg:text-xl sm:px-16 lg:px-48 dark:text-gray-200">
We have lot's of new trending Movies that you can't afford to miss</p>
        <button
        ...
        >
          ...
          <span className="text-l text-gray-100 font-medium">Check out our new trending movies and what our users say!</span>
        </button>
      </div>
