...
<div className="relative bg-gradient-to-b from-blue-200 to-blue-200/30 dark:from-blue-900 dark:to-blue-900/30 w-full min-h-screen pt-0 pb-0">
    ...
    <div className="max-w-md mx-auto px-4 py-8 text-white">
      ...
      <h2 className="text-2xl font-semibold text-blue-600 text-center mb-6">Login to continue</h2>
      ...
      <form onSubmit={handleSubmit} className="space-y-6">
        <div>
          <input
            ...
            placeholder="Email"
            required
            className="w-full px-4 py-3 rounded-md border text-blue-600 border-gray-300 bg-transparent focus:outline-none focus:ring-2 focus:ring-sky-500"
          />
        </div>
